...
image:https://goreportcard.com/badge/github.com/BaymaxRice/prometheus-nginxlog-exporter[link="https://goreportcard.com/report/github.com/BaymaxRice/prometheus-nginxlog-exporter", Go Report Card]
...
Have a look at the https://github.com/BaymaxRice/prometheus-nginxlog-exporter/releases[releases page]
...
Each https://github.com/BaymaxRice/prometheus-nginxlog-exporter/releases[release]
from 1.5.1 or newer provides both DEB and RPM packages.

DEB:

    $ wget https://github.com/BaymaxRice/prometheus-nginxlog-exporter/releases/download/v1.9.2/prometheus-nginxlog-exporter_1.9.2_linux_amd64.deb
    $ apt install ./prometheus-nginxlog-exporter_1.9.2_linux_amd64.deb

RPM:

    $ wget https://github.com/BaymaxRice/prometheus-nginxlog-exporter/releases/download/v1.9.2/prometheus-nginxlog-exporter_1.9.2_linux_amd64.rpm
...
https://github.com/BaymaxRice/prometheus-nginxlog-exporter/blob/master/res/package/prometheus-nginxlog-exporter.service[in this repository].
...
spec:
  containers:
    - name: web
      ...
      # ...
    - name: exporter
      image: docker.pkg.github.com/BaymaxRice/prometheus-nginxlog-exporter/exporter:v1
...
To build the exporter from source, simply build it with `go get`:
    ...
    $ go get github.com/BaymaxRice/prometheus-nginxlog-exporter

Alternatively, clone this repository and just run `go build`:

    $ git clone https://github.com/BaymaxRice/prometheus-nginxlog-exporter.git
...
Some details and history on this can be found in https://github.com/BaymaxRice/prometheus-nginxlog-exporter/issues/13[issue #13].
